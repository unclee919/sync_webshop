...
def build_visual_workspace():
    ...
    content_blocks = [
        ...
        {"id": "nc4", "type": "number_card", "data": {"number_card_name": "Webshop Revenue", "col": 3}},
    ...
    frappe.db.commit()
    frappe.clear_cache()
    print("Elite Visual Workspace built successfully with metrics and charts.")
