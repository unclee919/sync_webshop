...
def get_content():
    ...
    try:
        ...
        footer_settings_data = {
            "enabled": content_settings.footer_enabled,
            "footer_logo": full_url(content_settings.footer_logo) if content_settings.footer_logo else None,
            "copyright_en": content_settings.footer_copyright_en,
            "copyright_ar": content_settings.footer_copyright_ar,
            "columns": cols_data
        }
    except Exception:
        pass
    ...
    try:
        ...
        if announcement.announcement_enabled:
            announcement_data = {
                "message_en": announcement.announcement_message_en,
                "message_ar": announcement.announcement_message_ar,
                "background_color": announcement.announcement_background_color,
                "text_color": announcement.announcement_text_color,
                "link_url": announcement.announcement_link_url,
                "show_close_button": announcement.announcement_show_close_button
            }
    except Exception:
        pass
    ...
    response = {
        ...
        "copy": {
            ...
            "ui": {key: settings.get(key) for key in (
                ...
                "close_en", "close_ar", "selected_product_en", "selected_product_ar", "cart_title_en", "cart_title_ar", "cart_empty_en", "cart_empty_ar", "browse_products_en", "browse_products_ar", "checkout_en", "checkout_ar", "view_cart_en", "view_cart_ar", "free_shipping_unlocked_en", "free_shipping_unlocked_ar", "free_shipping_away_en", "free_shipping_away_ar", "cart_item_en", "cart_item_ar", "close_cart_en", "close_cart_ar",                 "free_shipping_progress_en", "free_shipping_progress_ar", "decrease_quantity_en", "decrease_quantity_ar", "increase_quantity_en", "increase_quantity_ar", "remove_en", "remove_ar", "subtotal_en", "subtotal_ar", "compare_products_en", "compare_products_ar", "compare_items_en", "compare_items_ar", "compare_now_en", "compare_now_ar", "clear_en", "clear_ar", "comparison_kicker_en", "comparison_kicker_ar", "comparison_title_en", "comparison_title_ar",                 "rating_en", "rating_ar", "availability_en", "availability_ar", "available_en", "available_ar", "close_quick_actions_en", "close_quick_actions_ar", "quick_actions_en", "quick_actions_ar", "search_en", "search_ar", "saved_en", "saved_ar", "bag_en", "bag_ar", "ai_help_en", "ai_help_ar", "whatsapp_en", "whatsapp_ar", "light_en", "light_ar", "dark_en", "dark_ar", "top_en", "top_ar", "open_quick_actions_en", "open_quick_actions_ar", "menu_en", "menu_ar", "full_name_placeholder_en", "full_name_placeholder_ar", "required_fields_en", "required_fields_ar", "valid_fields_en", "valid_fields_ar", "payment_start_error_en", "payment_start_error_ar", "checkout_title_en", "checkout_title_ar", "shipping_information_en", "shipping_information_ar", "full_name_en", "full_name_ar", "email_en", "email_ar", "primary_phone_en", "primary_phone_ar", "second_phone_en", "second_phone_ar", "governorate_en", "governorate_ar", "select_governorate_en", "select_governorate_ar", "city_en", "city_ar", "select_city_en", "select_city_ar", "detailed_address_en", "detailed_address_ar", "optional_location_en", "optional_location_ar", "location_placeholder_en", "location_placeholder_ar", "coupon_code_en", "coupon_code_ar", "apply_en", "apply_ar", "invalid_coupon_en", "invalid_coupon_ar", "coupon_applied_en", "coupon_applied_ar", "make_it_gift_en", "make_it_gift_ar", "add_gift_wrapping_en", "add_gift_wrapping_ar", "personal_note_en", "personal_note_ar", "fulfillment_en", "fulfillment_ar", "delivery_en", "delivery_ar", "store_pickup_en", "store_pickup_ar", "select_warehouse_en", "select_warehouse_ar", "delivery_date_en", "delivery_date_ar", "preferred_delivery_date_en", "preferred_delivery_date_ar", "payment_method_en", "payment_method_ar", "paymob_secure_hint_en", "paymob_secure_hint_ar", "processing_en", "processing_ar", "continue_payment_en", "continue_payment_ar", "confirm_order_en", "confirm_order_ar", "order_summary_en", "order_summary_ar", "discount_en", "discount_ar", "shipping_en", "shipping_ar", "free_en", "free_ar", "total_en", "total_ar", "retry_en", "retry_ar", "loading_en", "loading_ar"
            ...
            "feature": {key: settings.get(key) for key in (
                ...
                "ai_chat_error_en", "ai_chat_error_ar", "account_title_en", "account_title_ar", "account_subtitle_en", "account_subtitle_ar", "account_email_placeholder_en", "account_email_placeholder_ar", "open_dashboard_en", "open_dashboard_ar", "no_orders_en", "no_orders_ar", "orders_en", "orders_ar", "invoices_en", "invoices_ar", "return_requests_en", "return_requests_ar", "account_summary_en", "account_summary_ar", "loyalty_points_en", "loyalty_points_ar", "my_profile_en", "my_profile_ar", "save_changes_en", "save_changes_ar", "edit_profile_en", "edit_profile_ar", "download_pdf_en", "download_pdf_ar", "request_return_en", "request_return_ar", "cancel_en", "cancel_ar", "submit_request_en", "submit_request_ar", "return_reason_en", "return_reason_ar", "quantity_en", "quantity_ar", "return_success_en", "return_success_ar", "profile_saved_en", "profile_saved_ar", "address_saved_en", "address_saved_ar", "address_deleted_en", "address_deleted_ar", "total_spend_en", "total_spend_ar", "average_order_en", "average_order_ar", "completed_orders_en", "completed_orders_ar", "saved_addresses_en", "saved_addresses_ar", "add_address_en", "add_address_ar", "edit_address_en", "edit_address_ar", "delete_address_en", "delete_address_ar", "delete_address_confirm_en", "delete_address_confirm_ar", "address_line_en", "address_line_ar", "country_en", "country_ar", "postcode_en", "postcode_ar", "no_saved_addresses_en", "no_saved_addresses_ar", "no_invoices_en", "no_invoices_ar", "no_returns_en", "no_returns_ar", "item_added_to_bag_en", "item_added_to_bag_ar", "reorder_en", "reorder_ar", "membership_title_en", "membership_title_ar", "new_member_en", "new_member_ar", "member_discount_en", "member_discount_ar", "quote_status_prefix_en", "quote_status_prefix_ar", "quote_title_en", "quote_title_ar", "quote_kicker_en", "quote_kicker_ar", "quote_body_en", "quote_body_ar", "quote_name_en", "quote_name_ar", "quote_email_en", "quote_email_ar", "quote_phone_en", "quote_phone_ar", "quote_company_en", "quote_company_ar", "quote_notes_en", "quote_notes_ar", "quote_sending_en", "quote_sending_ar", "quote_send_en", "quote_send_ar", "login_validation_en", "login_validation_ar", "login_failed_en", "login_failed_ar", "connection_error_en", "connection_error_ar", "customer_sign_in_en", "customer_sign_in_ar", "mobile_phone_en", "mobile_phone_ar", "verifying_en", "verifying_ar", "continue_en", "continue_ar", "stripe_secure_hint_en", "stripe_secure_hint_ar", "pay_now_en", "pay_now_ar"
            )}
        },
        ...
        "complete_the_look_title_en": settings.get("complete_the_look_title_en") or "Complete the look",
            ...
            "experience_settings": {
                ...
                "presence_material_studio_enabled": settings.get("presence_material_studio_enabled", 1),
                "presence_material_studio_title_en": settings.get("presence_material_studio_title_en") or "Make it yours",
                "presence_material_studio_title_ar": settings.get("presence_material_studio_title_ar") or "صممه بطريقتك",
                "quote_requests_enabled": settings.get("quote_requests_enabled", 0),
                "quote_request_title_en": settings.get("quote_request_title_en") or "Request a tailored quote",
                "quote_request_title_ar": settings.get("quote_request_title_ar") or "اطلب عرض سعر مخصص",
                "quote_request_threshold": settings.get("quote_request_threshold", 10) or 10,
                "live_tracking_map_enabled": settings.get("live_tracking_map_enabled", 0),
                "live_tracking_title_en": settings.get("live_tracking_title_en") or "Your delivery, in view",
                "live_tracking_title_ar": settings.get("live_tracking_title_ar") or "شاهد مسار توصيلك",
                "social_proof_enabled": settings.get("social_proof_enabled", 0),
                "social_proof_viewer_enabled": settings.get("social_proof_viewer_enabled", 0),
                "social_proof_viewer_template_en": settings.get("social_proof_viewer_template_en") or "{count} people are viewing this now",
                "social_proof_viewer_template_ar": settings.get("social_proof_viewer_template_ar") or "{count} أشخاص يشاهدون هذا الآن",
            },
            "ultra_settings": {
