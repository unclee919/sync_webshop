...
doc_events = {
    ...
    "Webshop Live Session": {"on_update": "sync_webshop.api.utils.clear_webshop_cache"},
    "Webshop Social Pulse": {"on_update": "sync_webshop.api.utils.clear_webshop_cache"},
    "Webshop Community Post": {"on_update": "sync_webshop.api.utils.clear_webshop_cache"},
...
fixtures = [
    {
        ...
        "filters": [["name", "=", "Sync Webshop OTP Verification"]],
    }
]
