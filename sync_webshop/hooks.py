...
doc_events = {
    ...
    "Webshop Feature Settings": {"on_update": "sync_webshop.api.utils.clear_webshop_cache"},
    ...
    "Webshop Sensory Settings": {"on_update": "sync_webshop.api.utils.clear_webshop_cache"},
